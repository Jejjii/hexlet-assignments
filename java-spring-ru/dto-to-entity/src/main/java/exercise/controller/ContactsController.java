...
public class ContactsController {
    ...
    // BEGIN
    @PostMapping(path = "")
    @ResponseStatus(HttpStatus.CREATED) //Указываем ,что успешный ответ возвращает статус 201
    public ContactDTO create(@RequestBody ContactCreateDTO contactCreateDTO) {
        ...
        // Сохранение контакта в репозиторий
        Contact savedContact = contactRepository.save(contact);

        // Преобразование сохраненной сущности Contact в ContactDTO
